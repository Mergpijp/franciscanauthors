...
class Record(models.Model):
    ...
    name_date = models.CharField(max_length=250, blank=True)
    name_original = models.CharField(max_length=250, blank=True)
    name_latin = models.CharField(max_length=250, blank=True)
    personalia = models.TextField(max_length=500, blank=True)
    literature = models.TextField(max_length=1500, blank=True)
    ...
    literature_editions = models.TextField(max_length=1500, blank=True)
    vitea = models.TextField(max_length=500, blank=True)
    vitea_biographies = models.TextField(max_length=500, blank=True)
    works_editions = models.TextField(max_length=500, blank=True)
    editions_music = models.TextField(max_length=500, blank=True)
    surviving_works = models.TextField(max_length=500, blank=True)
    edities_studies = models.TextField(max_length=1500, blank=True)
    manuscripts_editions_literature = models.TextField(max_length=1500, blank=True)
    salimbenes_literary_legacy = models.TextField(max_length=1500, blank=True)
    ...
    studies = models.TextField(max_length=1500, blank=True)
    ...
    primo_vita_bona = models.TextField(max_length=500, blank=True)
